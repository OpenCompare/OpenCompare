  ...
  var _ = Kotlin.defineRootPackage(null, /** @lends _ */ {
    ...
    pcm: Kotlin.definePackage(null, /** @lends _.pcm */ {
      ...
      Partial: Kotlin.createTrait(function () {
        ...
        generated_KMF_ID: {
          get: function () {
            return this.$generated_KMF_ID_vw47b$;
          },
          set: function (tmp$0) {
            this.$generated_KMF_ID_vw47b$ = tmp$0;
          }
        },
        value: {
          get: function () {
      ...
      impl: Kotlin.definePackage(null, /** @lends _.pcm.impl */ {
        ...
        MultipleImpl: Kotlin.createClass(function () {
          ...
          removeSubvalues: function (subvaluesP) {
            ...
            if (_.kotlin.get_size_1(this._subvalues) === 2 && this._subvalues.containsKey_za3rmp$(subvaluesP.internalGetKey())) {
              throw new Kotlin.UnsupportedOperationException('The list of subvaluesP must contain at least 2 element. Can not remove sizeof(subvaluesP)=' + _.kotlin.get_size_1(this._subvalues));
            }
             else {
